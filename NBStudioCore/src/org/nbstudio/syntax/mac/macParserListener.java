...
public interface macParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link macParser#macrosAsCommand}.
	 * @param ctx the parse tree
	 */
	void enterMacrosAsCommand(@NotNull macParser.MacrosAsCommandContext ctx);
	/**
	 * Exit a parse tree produced by {@link macParser#macrosAsCommand}.
	 * @param ctx the parse tree
	 */
	void exitMacrosAsCommand(@NotNull macParser.MacrosAsCommandContext ctx);
