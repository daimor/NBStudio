...
public class ANTLRCharStream implements CharStream {
    ...
    private class CharStreamState extends org.antlr.runtime.CharStreamState {
        ...
        {
            return "index= "+index+"; line= "+line+"; charPositionInLine= "+charPositionInLine;
        }
    }
